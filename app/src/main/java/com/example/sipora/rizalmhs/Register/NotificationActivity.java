...
public class NotificationActivity extends AppCompatActivity {
    ...
    private void loadNotifikasi() {
        ...
        String url = "http://192.168.1.45/SIPORAWEB/backend/sipora_api/get_notifikasi.php?user_id=" + userId;

        StringRequest req = new StringRequest(url, res -> {
            try {
        ...
        }, err -> Toast.makeText(this, "Gagal terhubung", Toast.LENGTH_SHORT).show());
